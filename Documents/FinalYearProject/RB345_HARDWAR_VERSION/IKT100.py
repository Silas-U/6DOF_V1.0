...
class IKT100:
    ...
    def setRPY(self,t6=0, t5=0, t4=0):
        self.T4 = ((t4 + 0.1)/180.0)*math.pi
        self.T5 = ((t5 + 0.1)/180.0)*math.pi
        self.T6 = ((t6 + 0.1)/180.0)*math.pi
 ...
 #---------------------------------   
    ...
    def GET_TH6_DEG(self):
        R3_6 = self.GET_R3_6()
        #Th_6 = math.atan2(-R3_6[2][1] , R3_6[2][0])/math.pi * 180
